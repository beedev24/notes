...
urlpatterns = [
    ...
    path('theAdmin/school-subject/school/<int:school_id>/edit/', views.editSchool),
    ...
    path('theAdmin/school-subject/subject/<int:subject_id>/edit/', views.editSubject),
    ...
    path('theAdmin/notes/<int:note_id>/school/update/', views.updateNoteSchool),
    path('theAdmin/notes/<int:note_id>/subject/update/', views.updateNoteSubject),
